...
# Generated: Fri Jan 31 12:43:41 2020
##################################################
...
class amx(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        ...
        self.interp_fir_filter_xxx_0 = filter.interp_fir_filter_fff(30, (audio_taps))
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/akio/chop_sample.wav', True)
        self.blocks_wavfile_sink_0 = blocks.wavfile_sink('fading.wav', 1, 48000, 16)
        ...
        self.connect((self.blocks_multiply_xx_0, 0), (self.wxgui_scopesink2_2, 1))
