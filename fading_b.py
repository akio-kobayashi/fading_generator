...
file1='/media/akio/ssd1/fading_generator/long.wav'
file2='/media/akio/ssd1/fading_generator/fading+gauss.raw'
file3='/media/akio/ssd1/fading_generator/gauss_noise_only.raw'
file4='/media/akio/ssd1/fading_generator/original.raw'
file5='/media/akio/ssd1/fading_generator/fading.raw'
file6='/media/akio/ssd1/fading_generator/gauss_noise.raw'
file7='/media/akio/ssd1/fading_generator/carrier_fading.raw'
file8='/media/akio/ssd1/fading_generator/carrier_fading+gauss.raw'
...
class top_block(gr.top_block):
    ...
    def __init__(self, args):
        ...
        self.high_pass_filter_0 = filter.fir_filter_fff(1, firdes.high_pass(
        	1, samp_rate, 50, 10, firdes.WIN_HAMMING, 6.76))
        self.channels_fading_model_0 = channels.fading_model( 8, dpp/if_rate, True, 2, 256 )
